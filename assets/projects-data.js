...
window.LINGENIOUS_PROJECTS = [
  ...
  },
  {
    ...
    disciplines: ["Structural"],
    image: "https://images.unsplash.com/photo-1494905998402-395d579af36f?auto=format&fit=crop&w=800&q=70",
  ...
  {
    id: "commercial-office-tower-fire-safety",
    sector: "commercial",
    sectorLabel: "Commercial",
    name: "Commercial Office Tower Refurbishment",
    subtitle: "Fire Safety Engineering",
    location: "Commercial office towers, Melbourne CBD",
    scope: "Fire engineering input supporting refurbishment and upgrade works across occupied CBD commercial office towers.",
    stats: ["Fire Engineering Reports & Performance Solutions", "Multiple CBD office tower upgrades", "Coordinated with base-building compliance"],
    disciplines: ["Fire Safety"],
    image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=70",
    slug: "case-study-commercial-office-tower-fire-safety.html",
    challenge: "Refurbishment and upgrade works across several occupied CBD office towers needed to satisfy current fire safety requirements without disrupting base-building operations or triggering disproportionate upgrades to unrelated parts of each building.",
    approach: "Our fire safety engineering lead prepared fire engineering reports and performance-based solutions for each refurbishment, working through the existing base-building fire systems and egress arrangements to scope only the upgrade work genuinely required by each project.",
    outcome: "Each refurbishment proceeded with a fire safety strategy proportionate to the actual scope of works, avoiding unnecessary disruption to the operating buildings.",
    note: "Reflects our fire safety lead's professional experience delivered prior to and independently of Lingenious Consulting."
  },
  {
    id: "government-hospital-fire-safety-audit",
    sector: "government-infrastructure",
    sectorLabel: "Government + Infrastructure",
    name: "Hospital Fire Safety Compliance",
    subtitle: "Fire Risk Audit & Assessment",
    location: "Major hospital campuses, Melbourne",
    scope: "Statutory fire safety audits and fire risk assessments supporting compliance across major hospital campuses.",
    stats: ["Statutory periodic fire safety audits", "Fire risk assessments across live hospital campuses", "Coordinated with hospital operations & health authority requirements"],
    disciplines: ["Fire Safety"],
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&w=800&q=70",
    slug: "case-study-government-hospital-fire-safety-audit.html",
    challenge: "Hospital campuses must undergo periodic statutory fire safety audits and risk assessments, which need to be carried out without disrupting live clinical operations or patient care.",
    approach: "Our fire safety engineering lead carried out statutory fire safety audits and fire risk assessments across several major hospital campuses, working directly with hospital facilities teams to schedule inspections around operational and patient safety constraints.",
    outcome: "Each campus's fire safety audit was completed and reported to the standard required by the relevant health authority, supporting continued compliance for these critical care facilities.",
    note: "Reflects our fire safety lead's professional experience delivered prior to and independently of Lingenious Consulting."
  },
  {
    id: "government-public-market-scaffold-design",
    sector: "government-infrastructure",
    sectorLabel: "Government + Infrastructure",
    name: "Public Market Scaffold Design",
    subtitle: "Scaffold Engineering",
    location: "Public market building, Melbourne",
    scope: "Engineered scaffold design for construction access and fall protection at a council-owned public market building.",
    stats: ["6.5m scaffold height across varying roof lines", "Engineered to AS 1576 scaffolding standards", "Powerline & pedestrian clearance coordination"],
    disciplines: ["Structural"],
    image: "https://images.unsplash.com/photo-1541976590-713941681591?auto=format&fit=crop&w=800&q=70",
    slug: "case-study-government-public-market-scaffold-design.html",
    challenge: "Scaffold needed to be erected around an occupied public market building spanning multiple roof heights and step-downs, while maintaining safe clearances to overhead powerlines and the adjoining pedestrian footpath and crossing.",
    approach: "Lingenious engineered a bayed scaffold design tailored to each elevation's roof height and step-down, specifying handrail configurations, tie-in spacing and standards in accordance with AS 1576, and confirming safe working clearances to the wall frame, adjacent powerlines and street frontage.",
    outcome: "A fully engineered, standards-compliant scaffold design that gave safe access and fall protection across the building's varying roof lines without compromising public safety at the surrounding footpath and crossing."
  },
  {
